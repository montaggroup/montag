...
states = [STATE_UNPROCESSED, STATE_PROCESSING, STATE_UNIDENTIFIED, STATE_IDENTIFIED, STATE_UNCERTAIN]
...
class ImporterDB(sqlitedb.SqliteDB):
    ...
    def get_recently_identified_files(self):
        return self.get_list_of_objects('SELECT * FROM identifier_files WHERE input_state=? LIMIT 100', [STATE_IDENTIFIED])
